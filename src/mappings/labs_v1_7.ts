...
// Contracts
const vaultDaiAddress = Address.fromString(contracts.AVAXDAIVault_v1_7_Address);
const vaultUsdcAddress = Address.fromString(contracts.AVAXUSDCVault_v1_7_Address);
const vaultUsdtAddress = Address.fromString(contracts.AVAXUSDTVault_v1_7_Address);
const stratDaiAddress = Address.fromString(contracts.AVAXDAIStrategy_v1_7_Address);
const stratUsdcAddress = Address.fromString(contracts.AVAXUSDCStrategy_v1_7_Address);
const stratUsdtAddress = Address.fromString(contracts.AVAXUSDTStrategy_v1_7_Address);
